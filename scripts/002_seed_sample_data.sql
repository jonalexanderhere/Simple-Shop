-- Seed sample data for JonsStore Digital Solutions
...
('Requime BoostID', 'Shop. Digitalz', 'JonsStore Digital Solutions memberikan layanan yang sangat profesional. Website kami sekarang terlihat modern dan performa sangat baik!', 5, '/images/testimonial-1.jpg', true),
('Rifki Hermawan', 'Mahasiswa', 'Tim JonsStore sangat membantu dalam mengembangkan toko online kami. Penjualan meningkat 300% setelah menggunakan layanan mereka.', 5, '/images/testimonial-2.jpg', true),
('Danz Shop', 'Jb akun Game', 'Aplikasi mobile yang dikembangkan JonsStore sangat user-friendly dan stabil. Highly recommended!', 5, '/images/testimonial-3.jpg', true),
('Qinday Shop', 'Hosting Marketplace', 'Digital marketing package dari JonsStore membantu klinik kami mendapatkan lebih banyak pasien. ROI sangat memuaskan!', 4, '/images/testimonial-4.jpg', false),
('FadilJb', 'Shop. Online', 'Brand identity yang dibuat JonsStore sangat mencerminkan visi perusahaan kami. Terima kasih atas kerja sama yang baik!', 5, '/images/testimonial-5.jpg', false);
